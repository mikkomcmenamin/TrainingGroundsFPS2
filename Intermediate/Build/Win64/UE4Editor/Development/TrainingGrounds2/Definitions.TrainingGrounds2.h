...
#define ORIGINAL_FILE_NAME "UE4Editor-TrainingGrounds2.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_BUILD_DEVELOPMENT_WITH_DEBUGGAME 0
#define UE_PROJECT_NAME TrainingGrounds2
#define DEPRECATED_FORGAME DEPRECATED
#define TRAININGGROUNDS2_API DLLEXPORT
